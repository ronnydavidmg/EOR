...
while True:
    ...
    if not opc:  # si se presiona enter sin ingresar nada
        ...
        #DATOS IMPORTANTES DE PRUEBAS PVT
        ...
        la = "C:/users/Darling/Desktop/LGA-021.las"  #Directorio de computadora de autor, en otra computadora saldrá error.
        ...
        #for count, curve in enumerate(las.curves):
            #print(f"\n\033[1mCurva:\033[0m {curve.mnemonic} \t \n\033[1mUnidades:\033[0m {curve.unit} \t \n\033[1mDescripción:\033[0m {curve.descr}")

        #print(f"\nExiste un total de: \033[1m{count+1} curvas\033[0m en su archivo.")
        ...
        esp = esp * 0.3048
        esp = round(esp,3)
        print("\n", "\n\033[1mEl valor del espesor es:\033[0m", esp, "m")
        ...
        prof = prof * 0.3048
        prof = round(prof,3)
        print("\n", "\n\033[1mEl valor de la profundidad es:\033[0m", prof, "m")
        ...
        por = por * 100
        por = float(por)
        print("\n","\n\033[1mEl valor de porosidad es:\033[0m", por, "%")
        ...
        vis = round(vis,3)
        print("\n", "\n\033[1mEl valor de viscosidad es:\033[0m", vis, "cp")
        ...
        if vsh >= 0.6:
            roca = "LUTITA"
            print("\n\n\033[1mLa roca en su reservorio es:\033[0m", roca)
        else:
            roca = "ARENISCA"
            print("\n\n\033[1mLa roca en su reservorio es:\033[0m", roca)
...
for i in sorted_d:
    valor = sorted_d[i]
    n2 = round(valor, 2)
    print("\n\033[1mPuesto #\033[0m", "\033[1m", k, "\033[0m:", i, "Probabilidad de éxito:", "\033[1m", n2, "%", "\033[0m")
    k = k + 1
